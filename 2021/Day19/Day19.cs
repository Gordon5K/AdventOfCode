...
namespace AOC._2021
{
    class Day19 : TestClass, ITestClass
    {
        ...
        private readonly Dictionary<int, HashSet<Coord>> _readings;
        private readonly HashSet<Coord> _beaconMap;
        private readonly Dictionary<int, Coord> _scanners;

        public Day19()
        {
            _input = ReadInputFile();
            ...
            for (int i = 0; i < lines.Length; i++)
            {
                ...
                {
                    string[] parts = GetCommaDelimitedValues(line);
